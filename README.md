...
- [vueye-datatable](https://github.com/boussadjra/vueye-table) - it's a responsive data table component based on Vue.js 2, it organizes your data per pages in order to navigate easily, it allows you to sort, search, export data and change theme and ui language
### Notification
